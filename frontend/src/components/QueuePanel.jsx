        ...
        <form onSubmit={generateToken} className="space-y-4">
          <div>
            ...
            <input
              ...
              className="w-full border border-primary-100 rounded-2xl shadow-[0_1px_0_rgba(255,255,255,.8)_inset] px-4 py-3 text-base focus:border-primary-400 focus:ring-4 focus:ring-primary-100/60 outline-none transition-all"
          ...
          <button
            type="submit"
            className="w-full py-4 rounded-2xl bg-secondary-500 text-charcoal font-display font-semibold shadow-soft text-lg
        ...
        <div className="flex items-center justify-between mb-6">
          ...
          <button
            ...
            className="flex items-center gap-1.5 px-5 py-2 rounded-full bg-primary-500 text-white font-semibold text-base
              hover:bg-primary-600 hover:-translate-y-0.5 transition-all"
          >
